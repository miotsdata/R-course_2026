...
## 1.6 Bonus: how patient data were created

    set.seed(3564) # set randomness seed
    l <- 100 # define number of patients
    patient_data <- data.frame("patient_id" = 1:l, # create a vector from 1 to l
                               "weight" = rnorm(n = l, mean = 75, sd = 10), # create a vector of l random elements, uniform distribution with mean 75 and sd 10
                               "height" = rnorm(n = l, mean = 175, sd = 25))
...
have to change “never smoker” to “smoker”.
...
THIS SHOULD BE ONLY ON THE SITE, NOT IN STUDENTS MARKDOWN `select` also
supports handy helper functions:
...
Let’s see all approaches:
    ...
    summary(full_with_labs)
     ...
     Length:240         Length:240         Min.   :26.0   Female:118   never  :87  
     Class :character   Class :character   1st Qu.:49.0   Male  :122   former :90  
     Mode  :character   Mode  :character   Median :57.5                current:63  
                                           Mean   :57.3                            
                                           3rd Qu.:65.0                            
                                           Max.   :85.0                            
...
Solution
    ...
    # 2. Summarize (filter out NA first, or use na.rm = TRUE)
    lab_summary <- joined_df |>
      filter(!is.na(hemoglobin_gdl)) |>
      group_by(treatment) |>
...
<img src="R-course-2026_files/figure-markdown_strict/unnamed-chunk-87-1.png" alt="" width="85%" style="display: block; margin: auto;" />
...
<img src="R-course-2026_files/figure-markdown_strict/unnamed-chunk-88-1.png" alt="" width="85%" style="display: block; margin: auto;" />
...
<img src="R-course-2026_files/figure-markdown_strict/unnamed-chunk-94-1.png" alt="" width="85%" style="display: block; margin: auto;" />
...
<img src="R-course-2026_files/figure-markdown_strict/unnamed-chunk-113-1.png" alt="" width="85%" style="display: block; margin: auto;" />
...
<img src="R-course-2026_files/figure-markdown_strict/unnamed-chunk-121-1.png" alt="" width="85%" style="display: block; margin: auto;" />
...
Solution
    ...
    # Calculate outliers
    stageI_outliers <- (stageI_creatinine < quantile(stageI_creatinine, 0.25) - IQR(stageI_creatinine)) | (stageI_creatinine > quantile(stageI_creatinine, 0.75) + IQR(stageI_creatinine))

    stageIV_outliers <- (stageIV_creatinine < quantile(stageIV_creatinine, 0.25) - IQR(stageIV_creatinine)) | (stageIV_creatinine > quantile(stageIV_creatinine, 0.75) + IQR(stageIV_creatinine))
...
<img src="R-course-2026_files/figure-markdown_strict/unnamed-chunk-134-1.png" alt="" width="85%" style="display: block; margin: auto;" />
...
So, both sex and BMI class influence systolic\_bp\_mmhg; but to which
comparisons are significant we have to perform a pairwise t-test:

    groups <- interaction(df$BMI_class, df$sex)
    pairwise.t.test(x = df$systolic_bp_mmhg, g = groups, p.adjust.method = "bonferroni")


        Pairwise comparisons using t tests with pooled SD 

    data:  df$systolic_bp_mmhg and groups 

                       Normal.Female Obese.Female Overweight.Female
    Obese.Female       0.7081        -            -                
    Overweight.Female  1.0000        0.6921       -                
    Underweight.Female 1.0000        0.8083       1.0000           
    Normal.Male        0.2582        0.0025       0.0302           
    Obese.Male         1.0000        1.0000       1.0000           
    Overweight.Male    1.0000        0.0665       1.0000           
    Underweight.Male   1.0000        0.4657       1.0000           
                       Underweight.Female Normal.Male Obese.Male Overweight.Male
    Obese.Female       -                  -           -          -              
    Overweight.Female  -                  -           -          -              
    Underweight.Female -                  -           -          -              
    Normal.Male        0.0529             -           -          -              
    Obese.Male         1.0000             1.0000      -          -              
    Overweight.Male    1.0000             1.0000      1.0000     -              
    Underweight.Male   1.0000             0.3086      1.0000     1.0000         

    P value adjustment method: bonferroni 

So, overall, the difference is only between Normal Male and both Obese
...
<img src="R-course-2026_files/figure-markdown_strict/unnamed-chunk-139-1.png" alt="" width="85%" style="display: block; margin: auto;" />
...
<img src="R-course-2026_files/figure-markdown_strict/unnamed-chunk-146-1.png" alt="" width="85%" style="display: block; margin: auto;" />

    ggplot(pc_data_df) +
        geom_point(aes(x = PC1, y = PC2, color = diastolic_bp_mmhg > 90), size = 3) +
        theme_classic()

<img src="R-course-2026_files/figure-markdown_strict/unnamed-chunk-147-1.png" alt="" width="85%" style="display: block; margin: auto;" />
...
<img src="R-course-2026_files/figure-markdown_strict/unnamed-chunk-150-1.png" alt="" width="85%" style="display: block; margin: auto;" />
